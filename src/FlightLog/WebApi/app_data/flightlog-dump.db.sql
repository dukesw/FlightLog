...
CREATE TABLE IF NOT EXISTS "Account" (
	...
	"ClosedOn"	TEXT,
	CONSTRAINT "PK_Account" PRIMARY KEY("Id" AUTOINCREMENT)
);
CREATE TABLE IF NOT EXISTS "ModelStatus" (
	"Id"	INTEGER NOT NULL,
	"Name"	TEXT,
	"IsActive"	INTEGER NOT NULL,
	CONSTRAINT "PK_ModelStatus" PRIMARY KEY("Id" AUTOINCREMENT)
);
CREATE TABLE IF NOT EXISTS "BatteryType" (
	"Id"	INTEGER NOT NULL,
	"AccountId"	INTEGER NOT NULL,
	"CapacityMah"	INTEGER NOT NULL,
	"Cells"	INTEGER NOT NULL,
	"Type"	TEXT,
	"WeightInGrams"	INTEGER NOT NULL,
	CONSTRAINT "FK_BatteryType_Account_AccountId" FOREIGN KEY("AccountId") REFERENCES "Account"("Id") ON DELETE CASCADE,
	CONSTRAINT "PK_BatteryType" PRIMARY KEY("Id" AUTOINCREMENT)
);
CREATE TABLE IF NOT EXISTS "Location" (
	...
	CONSTRAINT "FK_Location_Account_AccountId" FOREIGN KEY("AccountId") REFERENCES "Account"("Id") ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "Pilot" (
	...
	"Registration"	TEXT,
	"Club"	TEXT,
	"DefaultTransmitterId"	INTEGER,
	CONSTRAINT "FK_Pilot_Account_AccountId" FOREIGN KEY("AccountId") REFERENCES "Account"("Id") ON DELETE CASCADE,
	CONSTRAINT "PK_Pilot" PRIMARY KEY("Id" AUTOINCREMENT)
);
CREATE TABLE IF NOT EXISTS "PowerPlant" (
	...
	"Notes"	TEXT,
	CONSTRAINT "FK_PowerPlant_Account_AccountId" FOREIGN KEY("AccountId") REFERENCES "Account"("Id") ON DELETE CASCADE,
	CONSTRAINT "PK_PowerPlant" PRIMARY KEY("Id" AUTOINCREMENT)
);
CREATE TABLE IF NOT EXISTS "Model" (
	...
	"MaidenedOn"	TEXT,
	"DisposedOn"	TEXT,
	"ModelStatusId"	INTEGER NOT NULL,
	"Notes"	TEXT,
	"SortOrder"	INTEGER NOT NULL,
	"TotalFlights"	INTEGER NOT NULL,
	CONSTRAINT "FK_Model_ModelStatus_ModelStatusId" FOREIGN KEY("ModelStatusId") REFERENCES "ModelStatus"("Id") ON DELETE RESTRICT,
	CONSTRAINT "FK_Model_Account_AccountId" FOREIGN KEY("AccountId") REFERENCES "Account"("Id") ON DELETE CASCADE,
	CONSTRAINT "PK_Model" PRIMARY KEY("Id" AUTOINCREMENT)
);
CREATE TABLE IF NOT EXISTS "Battery" (
	"Id"	INTEGER NOT NULL,
	"AccountId"	INTEGER NOT NULL,
	"BatteryNumber"	INTEGER NOT NULL,
	"BatteryTypeId"	INTEGER NOT NULL,
	"IsActive"	INTEGER NOT NULL,
	"Notes"	TEXT,
	"PurchaseDate"	TEXT NOT NULL,
	CONSTRAINT "FK_Battery_BatteryType_BatteryTypeId" FOREIGN KEY("BatteryTypeId") REFERENCES "BatteryType"("Id") ON DELETE RESTRICT,
	CONSTRAINT "FK_Battery_Account_AccountId" FOREIGN KEY("AccountId") REFERENCES "Account"("Id") ON DELETE CASCADE,
	CONSTRAINT "PK_Battery" PRIMARY KEY("Id" AUTOINCREMENT)
);
CREATE TABLE IF NOT EXISTS "BatteryCharge" (
	"Id"	INTEGER NOT NULL,
	"AccountId"	INTEGER NOT NULL,
	"ChargedOn"	TEXT NOT NULL,
	"Type"	INTEGER NOT NULL,
	"Mah"	INTEGER NOT NULL,
	"BatteryId"	INTEGER NOT NULL,
	CONSTRAINT "FK_BatteryCharge_Account_AccountId" FOREIGN KEY("AccountId") REFERENCES "Account"("Id") ON DELETE CASCADE,
	CONSTRAINT "FK_BatteryCharge_Battery_BatteryId" FOREIGN KEY("BatteryId") REFERENCES "Battery"("Id") ON DELETE CASCADE,
	CONSTRAINT "PK_BatteryCharge" PRIMARY KEY("Id" AUTOINCREMENT)
);
CREATE TABLE IF NOT EXISTS "MediaLink" (
	...
	"Uri"	TEXT,
	"FlightId"	INTEGER,
	CONSTRAINT "FK_MediaLink_Flight_FlightId" FOREIGN KEY("FlightId") REFERENCES "Flight"("Id"),
	CONSTRAINT "FK_MediaLink_Account_AccountId" FOREIGN KEY("AccountId") REFERENCES "Account"("Id") ON DELETE CASCADE,
	CONSTRAINT "PK_MediaLink" PRIMARY KEY("Id" AUTOINCREMENT)
);
CREATE TABLE IF NOT EXISTS "FlightTag" (
	"Id"	INTEGER NOT NULL,
	"Name"	TEXT,
	"SortOrder"	INTEGER NOT NULL,
	CONSTRAINT "PK_FlightTag" PRIMARY KEY("Id" AUTOINCREMENT)
);
CREATE TABLE IF NOT EXISTS "MaintenanceLogType" (
	"Id"	INTEGER NOT NULL,
	"Name"	TEXT,
	"SortOrder"	INTEGER NOT NULL,
	CONSTRAINT "PK_MaintenanceLogType" PRIMARY KEY("Id" AUTOINCREMENT)
);
CREATE TABLE IF NOT EXISTS "FlightFlightTag" (
	"FlightsId"	INTEGER NOT NULL,
	"TagsId"	INTEGER NOT NULL,
	CONSTRAINT "FK_FlightFlightTag_Flight_FlightsId" FOREIGN KEY("FlightsId") REFERENCES "Flight"("Id") ON DELETE CASCADE,
	CONSTRAINT "FK_FlightFlightTag_FlightTag_TagsId" FOREIGN KEY("TagsId") REFERENCES "FlightTag"("Id") ON DELETE CASCADE,
	CONSTRAINT "PK_FlightFlightTag" PRIMARY KEY("FlightsId","TagsId")
);
CREATE TABLE IF NOT EXISTS "MaintenanceLog" (
	...
	CONSTRAINT "FK_MaintenanceLog_MaintenanceLogType_TypeId" FOREIGN KEY("TypeId") REFERENCES "MaintenanceLogType"("Id") ON DELETE CASCADE,
	CONSTRAINT "FK_MaintenanceLog_Model_ModelId" FOREIGN KEY("ModelId") REFERENCES "Model"("Id") ON DELETE RESTRICT,
	CONSTRAINT "PK_MaintenanceLog" PRIMARY KEY("Id" AUTOINCREMENT)
);
CREATE TABLE IF NOT EXISTS "Transmitter" (
	...
	"Brand"	TEXT,
	"SerialNumber"	TEXT,
	CONSTRAINT "FK_Transmitter_Pilot_PilotId" FOREIGN KEY("PilotId") REFERENCES "Pilot"("Id") ON DELETE CASCADE,
	CONSTRAINT "FK_Transmitter_Account_AccountId" FOREIGN KEY("AccountId") REFERENCES "Account"("Id") ON DELETE CASCADE,
	CONSTRAINT "PK_Transmitter" PRIMARY KEY("Id" AUTOINCREMENT)
);
CREATE TABLE IF NOT EXISTS "Flight" (
	...
	"FlightMinutes"	REAL NOT NULL,
	"ModelFlightNumber"	INTEGER NOT NULL,
	"ModelId"	INTEGER NOT NULL,
	"PilotId"	INTEGER NOT NULL,
	"TransmitterId"	INTEGER,
	CONSTRAINT "FK_Flight_Location_FieldId" FOREIGN KEY("FieldId") REFERENCES "Location"("Id") ON DELETE CASCADE,
	CONSTRAINT "FK_Flight_Battery_BatteryId" FOREIGN KEY("BatteryId") REFERENCES "Battery"("Id"),
	CONSTRAINT "FK_Flight_Model_ModelId" FOREIGN KEY("ModelId") REFERENCES "Model"("Id") ON DELETE RESTRICT,
	CONSTRAINT "FK_Flight_Pilot_PilotId" FOREIGN KEY("PilotId") REFERENCES "Pilot"("Id") ON DELETE RESTRICT,
	CONSTRAINT "FK_Flight_Transmitter_TransmitterId" FOREIGN KEY("TransmitterId") REFERENCES "Transmitter"("Id"),
	CONSTRAINT "FK_Flight_Account_AccountId" FOREIGN KEY("AccountId") REFERENCES "Account"("Id") ON DELETE CASCADE,
	CONSTRAINT "PK_Flight" PRIMARY KEY("Id" AUTOINCREMENT)
);
...
CREATE INDEX IF NOT EXISTS "IX_Battery_AccountId" ON "Battery" (
	"AccountId"
);
CREATE INDEX IF NOT EXISTS "IX_Battery_BatteryTypeId" ON "Battery" (
	"BatteryTypeId"
);
CREATE INDEX IF NOT EXISTS "IX_BatteryCharge_AccountId" ON "BatteryCharge" (
	"AccountId"
);
CREATE INDEX IF NOT EXISTS "IX_BatteryCharge_BatteryId" ON "BatteryCharge" (
	"BatteryId"
);
CREATE INDEX IF NOT EXISTS "IX_BatteryType_AccountId" ON "BatteryType" (
	"AccountId"
);
CREATE INDEX IF NOT EXISTS "IX_Location_AccountId" ON "Location" (
	"AccountId"
);
CREATE INDEX IF NOT EXISTS "IX_MediaLink_AccountId" ON "MediaLink" (
	"AccountId"
);
CREATE INDEX IF NOT EXISTS "IX_MediaLink_FlightId" ON "MediaLink" (
	"FlightId"
);
CREATE INDEX IF NOT EXISTS "IX_Model_AccountId" ON "Model" (
	"AccountId"
);
CREATE INDEX IF NOT EXISTS "IX_Model_ModelStatusId" ON "Model" (
	"ModelStatusId"
);
CREATE INDEX IF NOT EXISTS "IX_Pilot_AccountId" ON "Pilot" (
	"AccountId"
);
CREATE INDEX IF NOT EXISTS "IX_PowerPlant_AccountId" ON "PowerPlant" (
	"AccountId"
);
CREATE INDEX IF NOT EXISTS "IX_FlightFlightTag_TagsId" ON "FlightFlightTag" (
	"TagsId"
);
CREATE INDEX IF NOT EXISTS "IX_MaintenanceLog_ModelId" ON "MaintenanceLog" (
	"ModelId"
);
CREATE INDEX IF NOT EXISTS "IX_MaintenanceLog_TypeId" ON "MaintenanceLog" (
	"TypeId"
);
CREATE INDEX IF NOT EXISTS "IX_Transmitter_AccountId" ON "Transmitter" (
	"AccountId"
);
CREATE INDEX IF NOT EXISTS "IX_Transmitter_PilotId" ON "Transmitter" (
	"PilotId"
);
CREATE INDEX IF NOT EXISTS "IX_Flight_AccountId" ON "Flight" (
	"AccountId"
);
CREATE INDEX IF NOT EXISTS "IX_Flight_BatteryId" ON "Flight" (
	"BatteryId"
);
CREATE INDEX IF NOT EXISTS "IX_Flight_FieldId" ON "Flight" (
	"FieldId"
);
CREATE INDEX IF NOT EXISTS "IX_Flight_ModelId" ON "Flight" (
	"ModelId"
);
CREATE INDEX IF NOT EXISTS "IX_Flight_PilotId" ON "Flight" (
	"PilotId"
);
CREATE INDEX IF NOT EXISTS "IX_Flight_TransmitterId" ON "Flight" (
	"TransmitterId"
);
COMMIT;
